...
const ResetPasswordPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(error.message === "Invalid or expired token" ? "Invalid or expired token. Please request a new reset link." : "Failed to reset password. Please try again.", {
        position: "top-right",
        autoClose: 3000,
        hideProgressBar: false,
        closeOnClick: true,
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-lg mx-auto shadow px-6 py-7 rounded bg-white">
        <h2 className="text-2xl uppercase font-medium mb-1 text-center">Reset Password</h2>
