      ...
      <div className="p-4 md:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <ul className="space-y-4">
            {[...Array(4)].map((_, index) => (
              <li key={index} className="bg-white rounded-lg shadow-md p-4 flex items-center justify-between animate-pulse">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            <div className="text-red-600 mb-2">
              ...
              <h3 className="text-lg font-semibold">Error Loading Wishlist</h3>
              <p className="text-sm">{error?.message || cartError?.message || "An unexpected error occurred"}</p>
            </div>
            <button
              onClick={() => router.push('/')}
